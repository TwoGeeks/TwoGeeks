...
void main() {
  group("Chatroom page test", () {
    ...
    testWidgets(
        "show porfile image, name and chat messages",
          ...
          await instance.collection("messages").document("$friendID-$ownID").collection("$friendID-$ownID").document("1593358014588").setData({
            "content": "Hi",
            "idFrom": friendID,
            "idTo": ownID,
            "timestamp": "1593358014639",
          });
          await instance.collection("messages").document("$friendID-$ownID").collection("$friendID-$ownID").document("1593358014589").setData({
